...
static void ulog_be_lvl(rt_uint8_t argc, char **argv)
{
    if (argc > 2)
    {
...
static void ulog_tag_lvl(rt_uint8_t argc, char **argv)
{
    if (argc > 2)
    {
        if ((atoi(argv[2]) <= LOG_FILTER_LVL_ALL) && (atoi(argv[2]) >= 0))
...
static void ulog_lvl(rt_uint8_t argc, char **argv)
{
    if (argc > 1)
    {
...
static void ulog_tag(rt_uint8_t argc, char **argv)
{
    if (argc > 1)
    {
...
static void ulog_kw(rt_uint8_t argc, char **argv)
{
    if (argc > 1)
    {
...
static void ulog_filter(rt_uint8_t argc, char **argv)
{
#ifndef ULOG_USING_SYSLOG
