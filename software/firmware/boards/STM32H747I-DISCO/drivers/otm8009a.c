...
static OTM8009A_Data_t OTM8009A_Data;
/* Private macros ------------------------------------------------------------*/
/* Private functions ---------------------------------------------------------*/
...
* Output        : Data Read
*******************************************************************************/
RT_WEAK int32_t otm8009a_read_reg(uint16_t reg, uint8_t *pdata, uint16_t length)
{
...
* Output        : None
*******************************************************************************/
RT_WEAK int32_t otm8009a_write_reg(uint16_t reg, const uint8_t *pdata, uint16_t length)
{
...
int32_t OTM8009A_Init(uint32_t ColorCoding, uint32_t Orientation)
{
  ...
  ret += otm8009a_write_reg(0xFF, lcd_reg_data1, 3);
  
  /* Enter ORISE Command 2 */
  /* Shift address to 0x80 */
  ret += otm8009a_write_reg(OTM8009A_CMD_NOP, &short_reg_data[2], 0);
  
  ret += otm8009a_write_reg(0xFF, lcd_reg_data2, 2);
  ...
  /* GVDD/NGVDD settings */
  ret += otm8009a_write_reg(OTM8009A_CMD_NOP, &short_reg_data[1], 0);
  ret += otm8009a_write_reg(0xD8, lcd_reg_data5, 2);
  ...
  ret += otm8009a_write_reg(0xB3, lcd_reg_data6, 2);
  
  /* GOAVST */
  ret += otm8009a_write_reg(OTM8009A_CMD_NOP, &short_reg_data[2], 0);
  ret += otm8009a_write_reg(0xCE, lcd_reg_data7, 6);
  
  ret += otm8009a_write_reg(OTM8009A_CMD_NOP, &short_reg_data[29], 0);
  ret += otm8009a_write_reg(0xCE, lcd_reg_data8, 14);
  
  ret += otm8009a_write_reg(OTM8009A_CMD_NOP, &short_reg_data[30], 0);
  ret += otm8009a_write_reg(0xCE, lcd_reg_data9, 14);
  
  ret += otm8009a_write_reg(OTM8009A_CMD_NOP, &short_reg_data[31], 0);
  ret += otm8009a_write_reg(0xCF, lcd_reg_data10, 10);
  
  ret += otm8009a_write_reg(OTM8009A_CMD_NOP, &short_reg_data[32], 0);
  ret += otm8009a_write_reg(0xCF, &short_reg_data[45], 0);
  
  ret += otm8009a_write_reg(OTM8009A_CMD_NOP, &short_reg_data[2], 0);
  ret += otm8009a_write_reg(0xCB, lcd_reg_data11, 10);
  
  ret += otm8009a_write_reg(OTM8009A_CMD_NOP, &short_reg_data[33], 0);
  ret += otm8009a_write_reg(0xCB, lcd_reg_data12, 15);
  
  ret += otm8009a_write_reg(OTM8009A_CMD_NOP, &short_reg_data[29], 0);
  ret += otm8009a_write_reg(0xCB, lcd_reg_data13, 15);
  
  ret += otm8009a_write_reg(OTM8009A_CMD_NOP, &short_reg_data[30], 0);
  ret += otm8009a_write_reg(0xCB, lcd_reg_data14, 10);
  
  ret += otm8009a_write_reg(OTM8009A_CMD_NOP, &short_reg_data[31], 0);
  ret += otm8009a_write_reg(0xCB, lcd_reg_data15, 15);
  
  ret += otm8009a_write_reg(OTM8009A_CMD_NOP, &short_reg_data[32], 0);
  ret += otm8009a_write_reg(0xCB, lcd_reg_data16, 15);
  
  ret += otm8009a_write_reg(OTM8009A_CMD_NOP, &short_reg_data[34], 0);
  ret += otm8009a_write_reg(0xCB, lcd_reg_data17, 10);
  
  ret += otm8009a_write_reg(OTM8009A_CMD_NOP, &short_reg_data[35], 0);
  ret += otm8009a_write_reg(0xCB, lcd_reg_data18, 10);
  
  ret += otm8009a_write_reg(OTM8009A_CMD_NOP, &short_reg_data[2], 0);
  ret += otm8009a_write_reg(0xCC, lcd_reg_data19, 10);
  
  ret += otm8009a_write_reg(OTM8009A_CMD_NOP, &short_reg_data[33], 0);
  ret += otm8009a_write_reg(0xCC, lcd_reg_data20, 15);
  
  ret += otm8009a_write_reg(OTM8009A_CMD_NOP, &short_reg_data[29], 0);
  ret += otm8009a_write_reg(0xCC, lcd_reg_data21, 15);
  
  ret += otm8009a_write_reg(OTM8009A_CMD_NOP, &short_reg_data[30], 0);
  ret += otm8009a_write_reg(0xCC, lcd_reg_data22, 10);
  
  ret += otm8009a_write_reg(OTM8009A_CMD_NOP, &short_reg_data[31], 0);
  ret += otm8009a_write_reg(0xCC, lcd_reg_data23, 15);
  
  ret += otm8009a_write_reg(OTM8009A_CMD_NOP, &short_reg_data[32], 0);
  ret += otm8009a_write_reg(0xCC, lcd_reg_data24, 15);
  ...
  /* Exit CMD2 mode */
  ret += otm8009a_write_reg(OTM8009A_CMD_NOP, &short_reg_data[1], 0);
  ret += otm8009a_write_reg(0xFF, lcd_reg_data25, 3);
  ...
  ret += otm8009a_write_reg(OTM8009A_CMD_NOP, &short_reg_data[1], 0);
  ret += otm8009a_write_reg(0xE1, lcd_reg_data3, 16);
  
  /* Gamma correction 2.2- table (HSDT possible) */
  ret += otm8009a_write_reg(OTM8009A_CMD_NOP, &short_reg_data[1], 0);
  ret += otm8009a_write_reg(0xE2, lcd_reg_data4, 16);
  ...
  case OTM8009A_FORMAT_RBG565 :
    ...
    ret += otm8009a_write_reg(OTM8009A_CMD_COLMOD, &short_reg_data[37], 0);
    OTM8009A_Data.ColorCode = OTM8009A_FORMAT_RBG565;
    break;
  case OTM8009A_FORMAT_RGB888 :
    /* Set Pixel color format to RGB888 */
    ret += otm8009a_write_reg(OTM8009A_CMD_COLMOD, &short_reg_data[38], 0);
    OTM8009A_Data.ColorCode = OTM8009A_FORMAT_RGB888;
    break;
  default :
    break;
  }
  ...
  if(Orientation == OTM8009A_ORIENTATION_LANDSCAPE)
  {
    ...
    ret += otm8009a_write_reg(OTM8009A_CMD_MADCTR, &tmp, 0);
    ret += otm8009a_write_reg(OTM8009A_CMD_CASET, LcdRegData27, 4);
    ret += otm8009a_write_reg(OTM8009A_CMD_PASET, LcdRegData28, 4);
    
    OTM8009A_Data.Orientation = OTM8009A_ORIENTATION_LANDSCAPE;
  }
  else
  {
    OTM8009A_Data.Orientation = OTM8009A_ORIENTATION_PORTRAIT;
  }
  
  /** CABC : Content Adaptive Backlight Control section start >> */
  /* Note : defaut is 0 (lowest Brightness], 0xFF is highest Brightness, try 0x7F : intermediate value */
  ret += otm8009a_write_reg(OTM8009A_CMD_WRDISBV, &short_reg_data[39], 0);
  /* Store default brightness */
  OTM8009A_Data.Brightness = ((uint32_t)short_reg_data[39] / 0xFFU) * 100U;
  
  /* defaut is 0, try 0x2C - Brightness Control Block, Display Dimming & BackLight on */
  ret += otm8009a_write_reg(OTM8009A_CMD_WRCTRLD, &short_reg_data[40], 0);
  
  /* defaut is 0, try 0x02 - image Content based Adaptive Brightness [Still Picture] */
  ret += otm8009a_write_reg(OTM8009A_CMD_WRCABC, &short_reg_data[41], 0);
  
  /* defaut is 0 (lowest Brightness], 0xFF is highest Brightness */
  ret += otm8009a_write_reg(OTM8009A_CMD_WRCABCMB, &short_reg_data[42], 0);
...
{ 
  ...
  if(otm8009a_read_reg(OTM8009A_CMD_ID1, (uint8_t *)Id, 0)!= OTM8009A_OK)
  {
    ret = OTM8009A_ERROR;
  }
  else
...
int32_t OTM8009A_SetBrightness(uint32_t Brightness)
{
  ...
  if(otm8009a_write_reg(OTM8009A_CMD_WRDISBV, &brightness, 0) != OTM8009A_OK)
  {
    ret = OTM8009A_ERROR;
  }
  else
  {
    OTM8009A_Data.Brightness = Brightness;
    ret = OTM8009A_OK;
  }
...
{
  *Brightness = OTM8009A_Data.Brightness;
  return OTM8009A_OK;  
}
...
int32_t OTM8009A_DisplayOn(void)
{
  ...
  /* Send Display on DCS command to display */
  if(otm8009a_write_reg(OTM8009A_CMD_DISPON, &display, 0) != OTM8009A_OK)
  {
    ret = OTM8009A_ERROR;
  }
  else
...
int32_t OTM8009A_DisplayOff(void)
{
  ...
  /* Send Display on DCS command to display */
  if(otm8009a_write_reg(OTM8009A_CMD_DISPOFF, &display, 0) != OTM8009A_OK)
  {
    ret = OTM8009A_ERROR;
  }
  else
...
int32_t OTM8009A_SetOrientation(uint32_t Orientation)
{
  ...
  {
    ret = otm8009a_write_reg(OTM8009A_CMD_MADCTR, &tmp1, 0);
    ret += otm8009a_write_reg(OTM8009A_CMD_CASET, LcdRegData27, 4);
    ret += otm8009a_write_reg(OTM8009A_CMD_PASET, LcdRegData28, 4);
...
int32_t OTM8009A_GetOrientation(uint32_t *Orientation)
{
  ...
  *Orientation = OTM8009A_Data.Orientation;
...
int32_t OTM8009A_GetXSize(uint32_t *Xsize)
{
  ...
  switch(OTM8009A_Data.Orientation)
  {
