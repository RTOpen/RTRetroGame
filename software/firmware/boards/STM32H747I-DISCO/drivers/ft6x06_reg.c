...
* Output        : pdata Read
*******************************************************************************/
 int32_t ft6x06_read_reg(uint8_t reg, uint8_t* pdata, uint16_t length)
{
  return length;
}
...
* Output        : None
*******************************************************************************/
int32_t ft6x06_write_reg(uint8_t reg, uint8_t *pdata, uint16_t length)
{
  return length;
}
...
int32_t  ft6x06_dev_mode_w(uint8_t value)
{
  ...
  ret = ft6x06_read_reg(FT6X06_DEV_MODE_REG, &tmp, 1);
  ...
  if(ret == 0)
  {
    ...
    ret = ft6x06_write_reg(FT6X06_DEV_MODE_REG, &tmp, 1);
  }
...
int32_t  ft6x06_dev_mode_r(uint8_t *value)
{
  ...
  ret = ft6x06_read_reg(FT6X06_DEV_MODE_REG, (uint8_t *)value, 1);
...
{
  return ft6x06_read_reg(FT6X06_GEST_ID_REG, (uint8_t *)value, 1);
}
...
int32_t  ft6x06_td_status(uint8_t *value)
{
  ...
  ret = ft6x06_read_reg(FT6X06_TD_STAT_REG, (uint8_t *)value, 1);
...
int32_t  ft6x06_p1_xh_ef(uint8_t *value)
{
  ...
  ret = ft6x06_read_reg(FT6X06_P1_XH_REG, (uint8_t *)value, 1);
...
{
  return ft6x06_read_reg(FT6X06_P1_XL_REG, (uint8_t *)value, 1);
}
...
int32_t  ft6x06_p1_yh_tid(uint8_t *value)
{
  ...
  ret = ft6x06_read_reg(FT6X06_P1_YH_REG, (uint8_t *)value, 1);
...
{
  return ft6x06_read_reg(FT6X06_P1_YL_REG, (uint8_t *)value, 1);
}
...
{
  return ft6x06_read_reg(FT6X06_P1_WEIGHT_REG, (uint8_t *)value, 1);
}
...
int32_t  ft6x06_p1_misc(uint8_t *value)
{
  ...
  ret = ft6x06_read_reg(FT6X06_P1_MISC_REG, (uint8_t *)value, 1);  
  if(ret == 0)
  {
...
int32_t  ft6x06_p2_xh_ef(uint8_t *value)
{
  ...
  ret = ft6x06_read_reg(FT6X06_P2_XH_REG, (uint8_t *)value, 1);
...
{
  return ft6x06_read_reg(FT6X06_P2_XL_REG, (uint8_t *)value, 1);
}
...
int32_t  ft6x06_p2_yh_tid(uint8_t *value)
{
  ...
  ret = ft6x06_read_reg(FT6X06_P2_YH_REG, (uint8_t *)value, 1);
...
{
  return ft6x06_read_reg(FT6X06_P2_YL_REG, (uint8_t *)value, 1);
}
...
{
  return ft6x06_read_reg(FT6X06_P2_WEIGHT_REG, (uint8_t *)value, 1);
}
...
int32_t  ft6x06_p2_misc(uint8_t *value)
{
  ...
  ret = ft6x06_read_reg(FT6X06_P2_MISC_REG, (uint8_t *)value, 1);
...
{
  return ft6x06_write_reg(FT6X06_TH_GROUP_REG, &value, 1);
}
...
{
  return ft6x06_write_reg(FT6X06_TH_DIFF_REG, &value, 1);
}
...
{
  return ft6x06_write_reg(FT6X06_CTRL_REG, &value, 1);
}
...
{
  return ft6x06_write_reg(FT6X06_TIMEENTERMONITOR_REG, &value, 1);
}
...
{
  return ft6x06_write_reg(FT6X06_PERIODACTIVE_REG, &value, 1);
}
...
{
  return ft6x06_write_reg(FT6X06_PERIODMONITOR_REG, &value, 1);
}
...
{
  return ft6x06_write_reg(FT6X06_RADIAN_VALUE_REG, &value, 1);
}
...
{
  return ft6x06_write_reg(FT6X06_OFFSET_LR_REG, &value, 1);
}
...
{
  return ft6x06_write_reg(FT6X06_OFFSET_UD_REG, &value, 1);
}
...
{
  return ft6x06_write_reg(FT6X06_DISTANCE_LR_REG, &value, 1);
}
...
{
  return ft6x06_write_reg(FT6X06_DISTANCE_UD_REG, &value, 1);
}
...
{
  return ft6x06_write_reg(FT6X06_DISTANCE_ZOOM_REG, &value, 1);
}
...
{
  return ft6x06_read_reg(FT6X06_LIB_VER_H_REG, (uint8_t *)value, 1);
}
...
{
  return ft6x06_read_reg(FT6X06_LIB_VER_L_REG, (uint8_t *)value, 1);
}
...
{
  return ft6x06_read_reg(FT6X06_CIPHER_REG, (uint8_t *)value, 1);
}
...
{
  return ft6x06_write_reg(FT6X06_GMODE_REG, &value, 1);
}
...
{
  return ft6x06_write_reg(FT6X06_PWR_MODE_REG, &value, 1); 
}
...
{
  return ft6x06_read_reg(FT6X06_FIRMID_REG, (uint8_t *)value, 1);
}
...
int32_t  ft6x06_chip_id(uint8_t *value)
{
  ...
  ret = ft6x06_read_reg(FT6X06_CHIP_ID_REG, (uint8_t *)value, 1);
...
{
  return ft6x06_read_reg(FT6X06_RELEASE_CODE_ID_REG, (uint8_t *)value, 1);
}
...
{
  return ft6x06_write_reg(FT6X06_STATE_REG, &value, 1);
}
